    ...
    var body: some View {
        ZStack{
            ...
            Path { (path) in
                ...
                }.fill(Color( red: 0.82, green: 1, blue: 0.27))
                ...
                Path(roundedRect: CGRect(x: 110, y: 470, width: 180,
                    height: 100), cornerRadius: 30).fill(Color( red: 0.82, green: 1, blue: 0.27))
                Path(roundedRect: CGRect(x: 50, y: 400, width: 45,
                        height: 130), cornerRadius: 30).fill(Color( red: 0.82, green: 1, blue: 0.27))
                Path(roundedRect: CGRect(x: 300, y: 330, width: 45,
                        height: 130), cornerRadius: 30).fill(Color( red: 0.82, green: 1, blue: 0.27)).rotationEffect(.degrees(-330))
                ...
                }.stroke(Color(red: 0.82  , green: 1, blue: 0.27), lineWidth: 3)
        }
            Path { (path) in
            ...
            Apple().scaleEffect(0.5).offset(x: 220, y: 140)
            Group{
